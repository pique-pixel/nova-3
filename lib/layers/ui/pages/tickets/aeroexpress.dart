...
class AeroexpressPage extends StatelessWidget {
  static route() => MaterialPageRoute(builder: (context) => AeroexpressPage());
                        ...
                        children: [
                          Padding(
                            ...
                            child: FadeBackgroundImage(
                              AssetImage("images/mock_images/aero.png"),
...
//                            ),
                            ...
                            SizedBox(height: 24),
                            _IconBar(
                              title: 'Режим работы: 04.30 - 00.30',
                              icon: Icons.event,
                            ),
                            _IconBar(
...
//                              value: _Time('≈ 5 ч 30 м'),
                      ...
                      Padding(
                        ...
                        child: Text(
                        '«Аэроэкспресс» - это наиболее удобный, быстрый и точный способ добраться из аэропорта '
                            'в центр города и обратно. Современные электропоезда курсируют по маршрутам '
                            '«Домодедово - Павелецкий вокзал», «Внуково - Киевский вокзал», '
                            '«Шереметьево - Белорусский вокзал - Одинцово».  '
                            'Выбирая «Аэроэкспресс», пассажиры получают высокий уровень безопасности движения, '
                            'клиентоориентированный сервис, малое время в пути, разнообразные тарифы, '
                            'комфорт в пути следования и в терминалах.',
                        ),
                      ),
                    ],
                  ),
