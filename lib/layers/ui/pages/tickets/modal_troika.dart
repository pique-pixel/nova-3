...
class ModalTroika extends PopupRoute {
  ModalTroika({RouteSettings settings}) : super(settings: settings);
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          ConstrainedBox(
            ...
            child: Text(
              'Используйте вашу карту "Тройка" в городском транспорте',
...
//          SizedBox(height: 30),
          ...
          Padding(
            ...
            child: Image.asset('images/troika_icon.png')//_QRCode(),
          ),
        ],
      ),
    );
