...
/// monthly calendar initially in the dialog shown by calling [showRussPassRangeDatePicker].
///
/// Also see:
///
      ...
      return new IgnorePointer(
        ...
        child: new _DateHeaderButton(
          ...
          child: new Semantics(
            ...
            child: new Text(localizations.formatYear(date), style: yearTextStyle),
          ),
        ),
      );
    }
...
class _DayPickerGridDelegate extends SliverGridDelegate {
  ...
  SliverGridLayout getLayout(SliverConstraints constraints) {
    ...
    final double tileHeight = math.min(
        _kDayPickerRowHeight, constraints.viewportMainAxisExtent / (_kMaxDayPickerRowCount + 1));
...
/// [showRussPassRangeDatePicker], which creates a date picker dialog.
///
/// See also:
///
///  * [showRussPassRangeDatePicker].
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; true; i += 1) {
      ...
      if (day < 1) {
        ...
        BoxDecoration decorationWhenFirstAndLast;
        ...
        final bool isInRange = selectedLastDate != null
            ? (dayToBuild.isBefore(selectedLastDate) && dayToBuild.isAfter(selectedFirstDate))
            : null;
        if (isSelectedFirstDay && (isSelectedLastDay == null || isSelectedLastDay)) {
          ...
          decorationWhenFirstAndLast = BoxDecoration(
            gradient: LinearGradient(
              colors: [AppColors.lightGray.withOpacity(0), AppColors.lightGray],
          ...
          decorationWhenFirstAndLast = BoxDecoration(
            gradient: LinearGradient(
              colors: [AppColors.lightGray, AppColors.lightGray.withOpacity(0)],
              begin: Alignment.centerLeft,
              end: Alignment.centerRight,
              tileMode: TileMode.clamp,
            ),
          ...
          decoration = new BoxDecoration(color: AppColors.lightGray, shape: BoxShape.rectangle);
        } else if (disabled) {
        ...
        Widget dayWidget = Container(
          decoration: decorationWhenFirstAndLast,
          child: Container(
            ...
            child: new Center(
              child: new Semantics(
                ...
                selected: isSelectedFirstDay || isSelectedLastDay != null && isSelectedLastDay,
        ...
        children: <Widget>[
          new Container(
            ...
            child: new Center(
              child: new ExcludeSemantics(
                child: new Text(
                  localizations.formatMonthYear(displayedMonth).replaceRange(
                      0, 1, localizations.formatMonthYear(displayedMonth)[0].toUpperCase()),
...
class MonthPicker extends StatefulWidget {
  ...
  /// by [showRussPassRangeDatePicker].
  MonthPicker({
    Key key,
    @required this.selectedFirstDate,
    this.selectedLastDate,
...
class _MonthPickerState extends State<MonthPicker> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _chevronOpacityAnimation = new Tween<double>(begin: 1.0, end: 0.0).animate(new CurvedAnimation(
    ...
    return new ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        final bool isSelected = year == widget.selectedFirstDate.year ||
            (widget.selectedLastDate != null && year == widget.selectedLastDate.year);
        ...
        return new InkWell(
          ...
          onTap: () {
            ...
            if (widget.selectedLastDate == null) {
              DateTime newDate =
                  new DateTime(year, widget.selectedFirstDate.month, widget.selectedFirstDate.day);
...
class _DatePickerDialog extends StatefulWidget {
  ...
  const _DatePickerDialog({
    ...
    this.onPressedSave(List<DateTime> result),
    this.cancelText,
    this.saveText,
    this.monthTextStyle,
  }) : super(key: key);
...
class _DatePickerDialogState extends State<_DatePickerDialog> {
  ...
  bool isSubmittedAndNowLoading = false;
  ...
  void _handleModeChanged(DatePickerMode mode) {
    ...
    setState(() {
      ...
      if (_mode == DatePickerMode.day) {
        SemanticsService.announce(localizations.formatMonthYear(_selectedFirstDate), textDirection);
        if (_selectedLastDate != null) {
          SemanticsService.announce(
              localizations.formatMonthYear(_selectedLastDate), textDirection);
        }
      } else {
        SemanticsService.announce(localizations.formatYear(_selectedFirstDate), textDirection);
        if (_selectedLastDate != null) {
          SemanticsService.announce(localizations.formatYear(_selectedLastDate), textDirection);
        }
      }
    });
  }
  ...
  void _handleCancel() {
    if (isSubmittedAndNowLoading) {
      print("Already loading and doing function onPressedSave. Wait sec ...");
      return null;
    }
  ...
  void _handleOk() async {
    ...
    await widget.onPressedSave(result);
  }
        ...
        children: <Widget>[
          ...
          new FlatButton(
            child: Container(
              ...
              child: isSubmittedAndNowLoading
                  ? IosLoadingIndicator()
                  : Text(
                      widget.saveText ?? "save",
                      style: GolosTextStyles.h3size16(golosTextColors: GolosTextColors.white),
                    ),
            ),
            onPressed: _handleOk,
          ),
...
///
/// See [showRussPassRangeDatePicker].
...
///  * [showTimePicker]
///  * <https://material.google.com/components/pickers.html#pickers-date-pickers>
Future<List<DateTime>> showRussPassRangeDatePicker({
  ...
  @required TextStyle yearTextStyle,
  @required Color backgroundColor,

  /// First loading indicator will start, and then perform [onPressedSave] function
  @required Future<void> onPressedSave(List<DateTime> result),
